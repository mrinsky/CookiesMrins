...
//    DataSaveLoad serSaveLoad = new SerFileWorking();
    ...
    public void loadAllEN(ArrayList<Tradition> traditions, LinkedList<Country> countries, LinkedList<Holiday> holidays) throws ClassNotFoundException, IOException, JDOMException, ParseException, SAXException;
