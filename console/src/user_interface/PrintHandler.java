...
public class PrintHandler {
    ...
    private static void chooseHoliday() {
        ...
        try {
            ...
            printArrayTraditions(Search.getTraditions(holiday, Resources.traditions));
    ...
    private static void chooseCountry() {
        ...
        try {
            int id = Integer.parseInt(MainMenu.reader.readLine());
            if (Search.getCountryTraditions(id,Resources.countries, Resources.traditions).size() != 0) {
                printTraditionTable();
                int count = 0;
    ...
    private static void printByCountry() {
        ...
        try {
            ...
            if (Search.getCountryTraditions(choice,Resources.countries, Resources.traditions).size() != 0) {
                printArrayTraditions(Search.getCountryTraditions(choice,Resources.countries,Resources.traditions));
                TraditionHandler.traditionMenu();
    ...
    private static void printByType(boolean validate) {
        ...
        while (true) {
            try {
                int choice = Integer.parseInt(MainMenu.reader.readLine());
                if (Search.getTypeHolidays(choice,Resources.holidays).size() != 0) {
                    printArrayHolidays(Search.getTypeHolidays(choice,Resources.holidays));
                    printHolidayMenu(validate);
                } else {
                    MainMenu.out.println(Resources.language.getNOT_FOUND());
                    showMenu();
    ...
    private static void printByToday(boolean validate) {
        ...
        if (Search.getDateHolidays(date,Resources.holidays).size() != 0) {
            printArrayHolidays(Search.getDateHolidays(date,Resources.holidays));
            printHolidayMenu(validate);
        } else {
            MainMenu.out.println(Resources.language.getNOT_FOUND());
            showMenu();
